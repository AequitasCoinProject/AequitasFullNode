...
namespace Stratis.Bitcoin.Features.MemoryPool.Tests
{
    public class MempoolPersistenceTest : IDisposable
    {
        ...
        {
            var amount = Money.FromUnit(satAmount, Network.MoneyUnit("Satoshi"));
        ...
        private static MempoolManager CreateTestMempool(NodeSettings settings, out TxMempool txMemPool)
        {
            ...
            var consensusValidator = new PowConsensusValidator(Network.BitcoinMain, new Checkpoints(Network.BitcoinMain, consensusSettings), dateTimeProvider, loggerFactory);
