...
namespace NBitcoin.Tests
{
    public class bloom_tests
    {
        ...
        public void bloom_create_insert_key()
        {
            ...
            BitcoinSecret vchSecret = Network.BitcoinMain.CreateBitcoinSecret(strSecret);
        ...
        public void bloom_match()
        {
            ...
            spendingTx.ReadWrite(vch, Network.BitcoinMain.Consensus.ConsensusFactory);
