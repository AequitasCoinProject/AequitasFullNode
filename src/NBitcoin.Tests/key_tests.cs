...
namespace NBitcoin.Tests
{
    public class key_tests
    {
        ...
        BitcoinPubKeyAddress addr1 = (BitcoinPubKeyAddress)Network.BitcoinMain.CreateBitcoinAddress("1QFqqMUD55ZV3PJEJZtaKCsQmjLT6JkjvJ");
        BitcoinPubKeyAddress addr2 = (BitcoinPubKeyAddress)Network.BitcoinMain.CreateBitcoinAddress("1F5y5E5FMc5YzdJtB9hLaUe43GDxEKXENJ");
        BitcoinPubKeyAddress addr1C = (BitcoinPubKeyAddress)Network.BitcoinMain.CreateBitcoinAddress("1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
        BitcoinPubKeyAddress addr2C = (BitcoinPubKeyAddress)Network.BitcoinMain.CreateBitcoinAddress("1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");


        BitcoinAddress addrLocal = Network.BitcoinMain.CreateBitcoinAddress("1Q1wVsNNiUo68caU7BfyFFQ8fVBqxC2DSc");
        ...
        public void CanVerifySignature()
        {
            ...
            foreach(var test in tests)
            {
                ...
                {
                    var secret = Network.BitcoinMain.CreateBitcoinSecret(test.PrivateKey);
