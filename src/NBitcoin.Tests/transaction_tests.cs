...
namespace NBitcoin.Tests
{
    public class transaction_tests
    {
        ...
        public void CanSignTransaction()
        {
            ...
            tx.Sign(Network.BitcoinMain, key, false);
            AssertCorrectlySigned(tx, scriptPubKey);
            clone.Sign(Network.BitcoinMain, key, true);
        ...
        public void CanGuessRedeemScriptWithInputKeys()
        {
            ...
            BitcoinAddress address = k.PubKey.WitHash.GetAddress(Network.BitcoinMain);
        ...
        public void CanBuildColoredTransaction()
        {
            ...
            catch (NotEnoughFundsException ex) //Not enough dust to send the change
            {
                ...
                Assert.Equal(gold.PubKey.Hash, change.ScriptPubKey.GetDestination(Network.BitcoinMain));
                ...
                {
                    Assert.False(TxNullDataTemplate.Instance.CheckScriptPubKey(Network.BitcoinMain, output.ScriptPubKey));
        ...
        public void CanBuildStealthTransaction()
        {
            ...
            var darkSatoshi = new BitcoinStealthAddress(scanKey.PubKey, stealthKeys.Select(k => k.PubKey).ToArray(), 2, new BitField(3, 5), Network.BitcoinMain);
        ...
        {
            return RandomCoin(amount, receiver.PubKey.GetAddress(Network.BitcoinMain));
        }
        ...
        private void BitcoinStreamCoverageCore<TItem>(TItem[] input, BitcoinStreamCoverageCoreDelegate<TItem> roundTrip)
        {
            ...
            bs.ConsensusFactory = Network.BitcoinMain.Consensus.ConsensusFactory;
            TItem[] before2 = input;
        ...
        private Transaction AssertClone(Transaction before)
        {
            ...
            stream.ConsensusFactory = Network.BitcoinMain.Consensus.ConsensusFactory;
        ...
        public void CantAskScriptCodeOnIncompleteCoin()
        {
            ...
            Assert.True(coin.CanGetScriptCode(Network.BitcoinMain));
            coin.ScriptPubKey = k.PubKey.ScriptPubKey.Hash.ScriptPubKey;
            Assert.False(coin.CanGetScriptCode(Network.BitcoinMain));
            Assert.Throws<InvalidOperationException>(() => coin.GetScriptCode(Network.BitcoinMain));
            Assert.True(coin.ToScriptCoin(k.PubKey.ScriptPubKey).CanGetScriptCode(Network.BitcoinMain));
            ...
            Assert.False(badCoin.CanGetScriptCode(Network.BitcoinMain));
            Assert.Throws<InvalidOperationException>(() => badCoin.GetScriptCode(Network.BitcoinMain));
            Assert.True(coin.ToScriptCoin(k.PubKey.ScriptPubKey).CanGetScriptCode(Network.BitcoinMain));
        }
        ...
        public void CanBuildWitTransaction()
        {
            ...
            Assert.True(builder.Verify(signedTx));
            Assert.Equal(previousCoin.ScriptPubKey, signedTx.Inputs[0].GetSigner(Network.BitcoinMain).ScriptPubKey);
            ...
            AssertEstimatedSize(signedTx, builder);
            Assert.True(builder.Verify(signedTx));
            Assert.Equal(witnessCoin.ScriptPubKey, signedTx.Inputs[0].GetSigner(Network.BitcoinMain).ScriptPubKey);
            ...
            AssertEstimatedSize(signedTx, builder);
            Assert.True(builder.Verify(signedTx));
            Assert.Equal(scriptCoin.ScriptPubKey, signedTx.Inputs[0].GetSigner(Network.BitcoinMain).ScriptPubKey);
            ...
            Transaction signedTx2 = signedTx.WithOptions(TransactionOptions.None, Network.BitcoinMain.Consensus.ConsensusFactory);
        ...
        public void CanCheckSegwitPubkey()
        {
            ...
            Assert.False(PayToWitTemplate.Instance.CheckScriptPubKey(Network.BitcoinMain, a));
            a = new Script("1 033fbe0a2aa8dc28ee3b2e271e3fedc7568529ffa20df179b803bf9073c1");
            Assert.True(PayToWitTemplate.Instance.CheckScriptPubKey(Network.BitcoinMain, a));
        ...
        public void CanEstimatedFeesCorrectlyIfFeesChangeTransactionSize()
        {
            ...
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 1), new TxOut("0.00010000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 2), new TxOut("0.00091824", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 3), new TxOut("0.00100000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 4), new TxOut("0.00100000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 5), new TxOut("0.00246414", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 6), new TxOut("0.00250980", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 7), new TxOut("0.01000000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Network.BitcoinMain))).ToScriptCoin(redeem));
            transactionBuilder.Send(new Key().PubKey.GetAddress(Network.BitcoinMain), "0.01000000");
            transactionBuilder.SetChange(new Key().PubKey.GetAddress(Network.BitcoinMain));
        ...
        public void CanBuildWithKnownSignatures()
        {
            ...
            TransactionSignature signature = tx.SignInput(Network.BitcoinMain, k, coin);
            ...
            Assert.True(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BitcoinMain, coin));
        }
        ...
        public void CanBuildTransaction()
        {
            ...
            BitcoinPubKeyAddress[] destinations = keys.Select(k => k.PubKey.GetAddress(Network.BitcoinMain)).ToArray();
            ...
            {
                TransactionSignature sig = partiallySigned.SignInput(Network.BitcoinMain, keys[0], coin);
        ...
        public void CanPartiallySignTransaction()
        {
            ...
            BitcoinAddress scriptAddress = redeem.Hash.GetAddress(Network.BitcoinMain);
            ...
            partiallySigned.Sign(Network.BitcoinMain, privKeys[0], true);

            //the other private keys (note the "hex" result getting longer):
            partiallySigned.Sign(Network.BitcoinMain, privKeys[1], true);
            ...
            partiallySigned.Sign(Network.BitcoinMain, privKeys[2], true);
            partiallySigned.Sign(Network.BitcoinMain, privKeys[0], true);
        ...
        private void AssertCorrectlySigned(Transaction tx, Script scriptPubKey, ScriptVerify scriptVerify = ScriptVerify.Standard)
        {
            ...
            {
                Assert.True(Script.VerifyScript(Network.BitcoinMain, scriptPubKey, tx, i, null, scriptVerify));
            }
        }

        private static StandardTransactionPolicy EasyPolicy = new StandardTransactionPolicy(Network.BitcoinMain)
        {
        ...
        private static StandardTransactionPolicy RelayPolicy = new StandardTransactionPolicy(Network.BitcoinMain)
        {
            MaxTransactionSize = null,
            MaxTxFee = null,
        ...
        public void TestWtfScript()
        {
            ...
            var ctx = new ScriptEvaluationContext(Network.BitcoinMain);
        ...
        public void CanCheckSegwitSig()
        {
            ...
            ScriptError error;
            Assert.True(toCheck.Inputs.AsIndexedInputs().Skip(0).First().VerifyScript(Network.BitcoinMain, new Script("OP_HASH160 442afa4f034468652c571202da0bf277cb729def OP_EQUAL"), Money.Satoshis(100000), ScriptVerify.Mandatory, out error));
        }
        ...
        private static void CanCheckSegwitSigCore(Transaction tx, int input, Money amount, string scriptCodeHex = null)
        {
            ...
            {
                PayToWitPubkeyHashScriptSigParameters param1 = PayToWitPubKeyHashTemplate.Instance.ExtractWitScriptParameters(Network.BitcoinMain, tx.Inputs[input].WitScript);
                Assert.NotNull(param1);
                WitKeyId param2 = PayToWitPubKeyHashTemplate.Instance.ExtractScriptPubKeyParameters(Network.BitcoinMain, param1.PublicKey.GetSegwitAddress(Network.BitcoinMain).Hash.ScriptPubKey);
            ...
            ScriptError err;
            bool r = Script.VerifyScript(Network.BitcoinMain, scriptCode, tx, 0, amount, out err);
            Assert.True(r);
        }
        ...
        public void CanParseWitTransaction()
        {
            ...
            Transaction noWit = tx.WithOptions(TransactionOptions.None, Network.BitcoinMain.Consensus.ConsensusFactory);
            ...
            ScriptError error;
            Assert.False(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BitcoinMain, new Script("0 b7854eb547106248b136ca2bf48d8df2f1167588"), out error));
        ...
        public void bip143Test()
        {
            ...
            uint256 h = Script.SignatureHash(Network.BitcoinMain, new Script(Encoders.Hex.DecodeData("76a9141d0f172a0ecb48aee1be1f2687d2963ae33f71a188ac")), tx, 1, SigHash.All, Money.Satoshis(0x23c34600L), HashVersion.Witness);
        ...
        public void witnessHasPushSizeLimit()
        {
            ...
            spending.Sign(Network.BitcoinMain, bob, coin);
            ScriptError error;
            Assert.True(spending.Inputs.AsIndexedInputs().First().VerifyScript(Network.BitcoinMain, coin, out error));
            spending.Inputs[0].WitScript = new WitScript(new[] { new byte[521] }.Concat(spending.Inputs[0].WitScript.Pushes).ToArray());
            Assert.False(spending.Inputs.AsIndexedInputs().First().VerifyScript(Network.BitcoinMain, coin, out error));
        ...
        private void PlayingWithSignatures()
        {
            ...
            ECDSASignature sig1 = (PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(Network.BitcoinMain, script1).TransactionSignature.Signature);
            ECDSASignature sig2 = (PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(Network.BitcoinMain, script2).TransactionSignature.Signature);
        ...
        public void Play2()
        {
            ...
            var builder2 = new TransactionBuilder(Network.BitcoinMain);
            builder2.SetTransactionPolicy(new StandardTransactionPolicy(Network.BitcoinMain)
            {
                CheckFee = false,
                MinRelayTxFee = null,
        ...
        public void CheckScriptCoinIsCoherent()
        {
            ...
            Assert.True(scriptCoin.GetHashVersion(Network.BitcoinMain) == HashVersion.Original);
            ...
            Assert.True(scriptCoin.RedeemType == RedeemType.P2SH);
            Assert.True(scriptCoin.IsP2SH);
            Assert.True(scriptCoin.GetHashVersion(Network.BitcoinMain) == HashVersion.Witness);
            ...
            Assert.Throws<ArgumentException>(() => ScriptCoin.Create(Network.BitcoinMain, c, key.PubKey.ScriptPubKey.WitHash.ScriptPubKey));
        }
        ...
        public void CheckWitnessSize()
        {
            ...
            tx.Outputs.Add(new TxOut(Money.Zero, new Script(OpcodeType.OP_TRUE)));
            ScriptError error;
            Assert.True(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BitcoinMain, coin1, ScriptVerify.Standard, out error));
            ...
            tx.Inputs[0].ScriptSig = Script.Empty;
            tx.Outputs.Add(new TxOut(Money.Zero, new Script(OpcodeType.OP_TRUE)));
            Assert.False(tx.Inputs.AsIndexedInputs().First().VerifyScript(Network.BitcoinMain, coin1, ScriptVerify.Standard, out error));
                ...
                foreach (SigHash flag in new[] { SigHash.Single, SigHash.None, SigHash.All })
                {
                    foreach (bool anyoneCanPay in new[] { true, false })
                    {
                        ...
                        foreach (HashModification modification in new[] { HashModification.NoModification, HashModification.Modification, HashModification.Invalid })
                        {
                            ...
                            var builder = new TransactionBuilder(Network.BitcoinMain);
                            builder.SetTransactionPolicy(new StandardTransactionPolicy(Network.BitcoinMain)
                            {
                                CheckFee = false,
                                CheckScriptPubKey = false,
                                MinRelayTxFee = null
                            ...
                            TransactionSignature sig = PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(Network.BitcoinMain, signedInput.WitScript == WitScript.Empty ? signedInput.ScriptSig : signedInput.WitScript.ToScript()).TransactionSignature;
                            if (modification != HashModification.Invalid)
                            {
                                signatures.Add(sig);
        ...
        public void tx_valid()
        {
            ...
            foreach (TestCase test in tests)
            {
                ...
                for (int i = 0; i < tx.Inputs.Count; i++)
                {
                    ...
                    bool valid = Script.VerifyScript(Network.BitcoinMain,
        ...
        public void tx_invalid()
        {
            ...
            foreach (TestCase test in tests)
            {
                ...
                for (int i = 0; i < tx.Inputs.Count && fValid; i++)
                {
                    ...
                    fValid = Script.VerifyScript(Network.BitcoinMain,
                       mapprevOutScriptPubKeys[tx.Inputs[i].PrevOut],
                       tx,
                       i,
                       mapprevOutScriptPubKeysAmount.TryGet(tx.Inputs[i].PrevOut),
        ...
        public void test_Get()
        {
            ...
            Assert.True(StandardScripts.AreInputsStandard(Network.BitcoinMain, t1, coins));
        ...
        private Transaction[] SetupDummyInputs(CoinsView coinsRet)
        {
            ...
            coinsRet.AddTransaction(Network.BitcoinMain.Consensus, dummyTransactions[0], 0);
            ...
            coinsRet.AddTransaction(Network.BitcoinMain.Consensus, dummyTransactions[1], 0);
        ...
        private static TransactionBuilder CreateBuilder(CKeyStore keystore, Transaction txFrom)
        {
            ...
            TransactionBuilder builder = new TransactionBuilder(Network.BitcoinMain)
            {
                StandardTransactionPolicy = new StandardTransactionPolicy(Network.BitcoinMain)
                {
                    CheckFee = false,
                    MinRelayTxFee = null,
#if !NOCONSENSUSLIB
        ...
        public void CanDecodeAndEncodeRawTransaction()
        {
            ...
            foreach (TestCase test in tests)
            {
                ...
                Network network = ((string)test[1]) == "Main" ? Network.BitcoinMain : Network.BitcoinTest;
