...
namespace Stratis.Bitcoin.Features.RPC.Tests.Models
{
    public class GetInfoModelTest : BaseRPCModelTest
    {
        ...
        public void GetInfoDeserializeFullTest()
        {
            ...
            Assert.Equal(Money.Satoshis(2).ToUnit(Network.MoneyUnit("BTC")), model.Balance);
            ...
            Assert.Equal(Money.Satoshis(10000).ToUnit(Network.MoneyUnit("BTC")), model.PayTxFee);
            Assert.Equal(Money.Satoshis(1000).ToUnit(Network.MoneyUnit("BTC")), model.RelayFee);
