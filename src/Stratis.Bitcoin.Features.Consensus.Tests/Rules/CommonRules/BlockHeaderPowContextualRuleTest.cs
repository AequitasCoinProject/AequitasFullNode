...
namespace Stratis.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class BlockHeaderPowContextualRuleTest
    {
        ...
        public async Task CheckHeaderBits_ValidationFailAsync()
        {
            ...
            RuleContext context = new PowRuleContext(new ValidationContext (), Network.BitcoinRegTest.Consensus, testContext.Chain.Tip);
            context.ValidationContext.Block = TestRulesContextFactory.MineBlock(Network.BitcoinRegTest, testContext.Chain);
            ...
            // increment the bits.
            context.NextWorkRequired = context.ValidationContext.ChainedHeader.GetNextWorkRequired(Network.BitcoinRegTest.Consensus);
