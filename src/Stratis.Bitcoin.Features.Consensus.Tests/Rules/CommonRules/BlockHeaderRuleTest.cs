...
namespace Stratis.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class BlockHeaderRuleTest
    {
        ...
        public async Task BlockReceived_IsNextBlock_ValidationSucessAsync()
        {
            ...
            var context = new PowRuleContext(new ValidationContext(), Network.BitcoinRegTest.Consensus, testContext.Chain.Tip);
            context.ValidationContext.Block = Network.BitcoinRegTest.Consensus.ConsensusFactory.CreateBlock();
