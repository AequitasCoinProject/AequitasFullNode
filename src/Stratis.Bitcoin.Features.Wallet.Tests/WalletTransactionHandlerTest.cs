...
namespace Stratis.Bitcoin.Features.Wallet.Tests
{
    public class WalletTransactionHandlerTest : LogsTestBase
    {
        ...
        public void BuildTransactionThrowsWalletExceptionWhenMoneyIsZero()
        {
            ...
            {
                var walletTransactionHandler = new WalletTransactionHandler(this.LoggerFactory.Object, new Mock<IWalletManager>().Object, new Mock<IWalletFeePolicy>().Object, Network.BitcoinMain);
        ...
        public void BuildTransactionNoSpendableTransactionsThrowsWalletException()
        {
            Assert.Throws<WalletException>(() =>
            {
                ...
                var walletManager = new WalletManager(this.LoggerFactory.Object, Network.BitcoinMain, chain.Object, NodeSettings.Default(), new Mock<WalletSettings>().Object,
                ...
                var walletTransactionHandler = new WalletTransactionHandler(this.LoggerFactory.Object, walletManager, new Mock<IWalletFeePolicy>().Object, Network.BitcoinMain);
        ...
        public void BuildTransactionFeeTooLowThrowsWalletException()
        {
            Assert.Throws<WalletException>(() =>
            {
                ...
                var walletTransactionHandler = new WalletTransactionHandler(this.LoggerFactory.Object, walletManager, walletFeePolicy.Object, Network.BitcoinMain);
        ...
        public void BuildTransactionNoChangeAdressesLeftCreatesNewChangeAddress()
        {
            ...
            var walletManager = new WalletManager(this.LoggerFactory.Object, Network.BitcoinMain, chain, NodeSettings.Default(), new Mock<WalletSettings>().Object, dataFolder,
        ...
        public void Given_AnInvalidAccountIsUsed_When_GetMaximumSpendableAmountIsCalled_Then_AnExceptionIsThrown()
        {
            ...
            var walletTransactionHandler = new WalletTransactionHandler(this.LoggerFactory.Object, walletManager, It.IsAny<WalletFeePolicy>(), Network.BitcoinMain);
        ...
        public void Given_GetMaximumSpendableAmountIsCalled_When_ThereAreNoSpendableFound_Then_MaxAmountReturnsAsZero()
        {
            ...
            var walletManager = new WalletManager(this.LoggerFactory.Object, Network.BitcoinMain, new ConcurrentChain(Network.BitcoinMain), NodeSettings.Default(), new Mock<WalletSettings>().Object,
                dataFolder, new Mock<IWalletFeePolicy>().Object, new Mock<IAsyncLoopFactory>().Object, new NodeLifetime(), DateTimeProvider.Default);
        ...
        public void EstimateFeeWithLowFeeMatchesBuildTxLowFee()
        {
            ...
            var walletManager = new WalletManager(this.LoggerFactory.Object, Network.BitcoinMain, chain, NodeSettings.Default(), new Mock<WalletSettings>().Object, 
                dataFolder, walletFeePolicy.Object, new Mock<IAsyncLoopFactory>().Object, new NodeLifetime(), DateTimeProvider.Default);
            WalletTransactionHandler walletTransactionHandler = new WalletTransactionHandler(this.LoggerFactory.Object, walletManager, walletFeePolicy.Object, Network.BitcoinMain);
