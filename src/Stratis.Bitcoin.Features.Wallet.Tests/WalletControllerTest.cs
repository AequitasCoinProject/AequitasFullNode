...
namespace Stratis.Bitcoin.Features.Wallet.Tests
{
    public class WalletControllerTest : LogsTestBase
    {
        ...
        public void GetGeneralInfoSuccessfullyReturnsWalletGeneralInfoModel()
        {
            var wallet = new Wallet
            {
                ...
                AccountsRoot = new List<AccountRoot> {
                    new AccountRoot()
                    {
                        CoinType = (CoinType)Network.BitcoinMain.Consensus.CoinType,
            ...
            var controller = new WalletController(this.LoggerFactory.Object, mockWalletWrapper.Object, new Mock<IWalletTransactionHandler>().Object, new Mock<IWalletSyncManager>().Object, connectionManagerMock.Object, Network.BitcoinMain, concurrentChain, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
        ...
        public void GetBalanceWithValidModelStateReturnsWalletBalanceModel()
        {
            ...
            Assert.Equal(Network.BitcoinMain.Consensus.CoinType, (int)resultingBalance.CoinType);
        ...
        public void GetAddressBalanceWithValidModelStateReturnsAddressBalanceModel()
        {
            ...
            Assert.NotNull(model);
            Assert.Equal(Network.BitcoinMain.Consensus.CoinType, (int)model.CoinType);
        ...
        public void BuildTransactionWithValidRequestAllowingUnconfirmedReturnsWalletBuildTransactionModel()
        {
            ...
            var controller = new WalletController(this.LoggerFactory.Object, mockWalletWrapper.Object, mockWalletTransactionHandler.Object, new Mock<IWalletSyncManager>().Object, It.IsAny<ConnectionManager>(), Network.BitcoinMain, new Mock<ConcurrentChain>().Object, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
            IActionResult result = controller.BuildTransaction(new BuildTransactionRequest
            {
                AccountName = "Account 1",
                AllowUnconfirmed = true,
                Amount = new Money(150000).ToString(),
                DestinationAddress = key.PubKey.GetAddress(Network.BitcoinMain).ToString(),
                FeeType = "105",
                Password = "test",
                WalletName = "myWallet"
            });
        ...
        public void SendTransactionSuccessfulReturnsWalletSendTransactionModelResponse()
        {
            ...
            var controller = new WalletController(this.LoggerFactory.Object, new Mock<IWalletManager>().Object, new Mock<IWalletTransactionHandler>().Object,
                new Mock<IWalletSyncManager>().Object, connectionManagerMock.Object, Network.BitcoinMain, new Mock<ConcurrentChain>().Object, mockWalletWrapper.Object, DateTimeProvider.Default);
        ...
        public void ListWalletFilesWithExistingWalletFilesReturnsWalletFileModel()
        {
            ...
            var controller = new WalletController(this.LoggerFactory.Object, walletManager.Object, new Mock<IWalletTransactionHandler>().Object, new Mock<IWalletSyncManager>().Object, It.IsAny<ConnectionManager>(), Network.BitcoinMain, new Mock<ConcurrentChain>().Object, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
        ...
        public void RemoveAllTransactionsWithSyncEnabledSyncsAfterRemoval()
        {
            ...
            ConcurrentChain chain = WalletTestsHelpers.GenerateChainWithHeight(3, Network.BitcoinMain);

            var controller = new WalletController(this.LoggerFactory.Object, walletManager.Object, new Mock<IWalletTransactionHandler>().Object, walletSyncManager.Object, It.IsAny<ConnectionManager>(), Network.BitcoinMain, chain, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
