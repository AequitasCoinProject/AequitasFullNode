    ...
    public class LightWalletBitcoinExternalFeePolicy : IWalletFeePolicy
    {
        ...
        public void Start()
        {
            this.asyncLoop = this.asyncLoopFactory.Run(nameof(LightWalletBitcoinExternalFeePolicy), async token =>
            {
                ...
                this.lowTxFeePerKb = new FeeRate(new Money((int)(json.Value<decimal>("low_fee_per_kb")), Network.MoneyUnit("Satoshi")));
                this.mediumTxFeePerKb = new FeeRate(new Money((int)(json.Value<decimal>("medium_fee_per_kb")), Network.MoneyUnit("Satoshi")));
                this.highTxFeePerKb = new FeeRate(new Money((int)(json.Value<decimal>("high_fee_per_kb")), Network.MoneyUnit("Satoshi")));
