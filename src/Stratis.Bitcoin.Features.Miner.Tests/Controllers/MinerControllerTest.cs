    ...
    public class MinerControllerTest : LogsTestBase
    {
        ...
        public void StartStaking_ValidWalletAndPassword_StartsStaking_ReturnsOk()
        {
            ...
            this.fullNode.Setup(f => f.NodeFeature<MiningFeature>(true))
                .Returns(new MiningFeature(Network.BitcoinMain, new MinerSettings(Configuration.NodeSettings.Default()), Configuration.NodeSettings.Default(), this.LoggerFactory.Object, this.timeSyncBehaviorState.Object, null, this.posMinting.Object));
