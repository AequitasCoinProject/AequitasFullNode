    ...
    public class SegWitTests
    {
        ...
        public void TestSegwit_MinedOnCore_ActivatedOn_StratisNode()
        {
            using (NodeBuilder builder = NodeBuilder.Create(version: "0.15.1"))
            {
                ...
                BIP9DeploymentsParameters prevSegwitDeployment = Network.BitcoinRegTest.Consensus.BIP9Deployments[BIP9Deployments.Segwit];
                Network.BitcoinRegTest.Consensus.BIP9Deployments[BIP9Deployments.Segwit] = new BIP9DeploymentsParameters(1, 0, DateTime.Now.AddDays(50).ToUnixTimestamp());
                ...
                {
                    Network.BitcoinRegTest.Consensus.BIP9Deployments[BIP9Deployments.Segwit] = prevSegwitDeployment;
                }
            }
        }
