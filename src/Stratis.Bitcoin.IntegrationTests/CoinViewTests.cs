...
namespace Stratis.Bitcoin.IntegrationTests
{
    public class CoinViewTests
    {
        ...
        public CoinViewTests()
        {
            ...
            this.dbreezeSerializer.Initialize(Network.BitcoinMain);
        }
        ...
        public void CanCheckBlockWithWitness()
        {
            ...
            var options = Network.BitcoinMain.Consensus.Option<PowConsensusOptions>();
            foreach (Transaction tx in block.Transactions)
                rule.CheckTransaction(Network.BitcoinMain, options, tx);
        }
    }
}
